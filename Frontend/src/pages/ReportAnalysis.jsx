...
const ReportAnalysis = () => {
  ...
  const getDiseaseColor = (disease) => {
    const colors = {
      ...
      'Multiple Conditions': 'text-teal-600 bg-teal-50 border-teal-200',
  ...
  const exportResultsAsPDF = () => {
    ...
    const addHeaderOnNewPage = () => {
      ...
      doc.text('HealthPath AI', margin + 2, 10);
    ...
    const addFooter = () => {
      ...
      doc.text(`© HealthPath AI ${new Date().getFullYear()}`, pageWidth - margin - 35, footerY);
    };
    ...
    if (reportedSymptoms.length > 0) {
      ...
      reportedSymptoms.forEach((symptom, index) => {
        ...
        doc.setTextColor(26, 54, 93);
        doc.setFont(undefined, 'normal');
        doc.text(`âœ“ ${symptom}`, margin + 2, yPos);
        yPos += 3.5;
      });
    ...
    const disclaimerText = [
      ...
      '',
      'â€¢ Always consult with a licensed physician or healthcare professional',
      'â€¢ Seek immediate medical attention for urgent health concerns',
      'â€¢ This system analysis should not be solely relied upon for medical decisions',
      'â€¢ All medical conditions require personalized professional evaluation'
    ];
    ...
    // Save PDF
    doc.save(`HealthPath-Medical-Report-${reportId}-${new Date().toISOString().split('T')[0]}.pdf`);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-sky-50 py-8 px-4">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <button
                onClick={() => navigate(-1)}
                className="p-2 hover:bg-sky-100 rounded-xl transition-all duration-200 hover:scale-105"
              >
                <ArrowLeft className="w-6 h-6 text-sky-600" />
              </button>
              <div className="flex items-center gap-3">
                <div className="p-3 bg-gradient-to-br from-sky-500 to-teal-600 rounded-xl shadow-lg">
          ...
          <div className="xl:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-sky-50 text-sky-700 rounded-lg hover:bg-sky-100 transition font-medium"
              >
                Fill Sample Data
              </button>
            </div>
                      ...
                      return (
                        <div key={field.key} className="space-y-2">
                          <label className="flex items-center gap-2 text-sm font-medium text-gray-700">
                            <FieldIcon className="w-4 h-4 text-sky-500" />
                            {field.label}
                          ...
                          {field.type === 'select' ? (
                            <select
                              ...
                              className={`w-full px-4 py-2.5 border-2 rounded-lg focus:ring-2 focus:ring-sky-500 transition bg-white ${
            ...
            <div className="flex gap-3 mt-6 pt-6 border-t border-gray-200">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-sky-600 to-teal-600 text-white px-6 py-3.5 rounded-xl font-semibold hover:from-sky-700 hover:to-teal-700 disabled:from-gray-400 disabled:to-gray-500 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02]"
              >
                {loading ? (
                  <>
            ...
            {analysisResult ? (
              <div className="space-y-5">
                ...
                <div className={`p-6 rounded-xl border-2 ${getDiseaseColor(analysisResult.analysis.prediction)}`}>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="w-full bg-white/60 rounded-full h-4 overflow-hidden">
                      <div
                        className="h-full rounded-full transition-all duration-1000 bg-gradient-to-r from-sky-500 to-teal-500 shadow-sm"
                ...
                <button
                  ...
                  className="w-full mt-4 px-4 py-3 bg-gradient-to-r from-sky-600 to-teal-600 hover:from-sky-700 hover:to-teal-700 rounded-xl flex items-center justify-center gap-2 text-sm font-semibold text-white transition-all shadow-sm hover:shadow"
                >
              ...
              <div className="text-center py-16 text-gray-400">
                <div className="p-4 bg-gradient-to-br from-sky-50 to-teal-50 rounded-2xl w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                  <Brain className="w-10 h-10 text-sky-400 opacity-50" />
                </div>
