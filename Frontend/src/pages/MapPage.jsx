...
const MapPage = () => {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-blue-50 via-sky-50 to-teal-50 relative">
                ...
                >
                        ...
                        <Marker
                            ...
                            icon={{
                                url: 'data:image/svg+xml;charset=UTF-8,' + encodeURIComponent(
                                    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32"><circle cx="16" cy="16" r="14" fill="%23ef4444" stroke="%23ffffff" stroke-width="2"/><text x="16" y="20" font-size="16" text-anchor="middle" fill="white" dominant-baseline="middle">ðŸ¥</text></svg>'
                                ),
                    ...
                    {savedLocations.map((location, idx) => (
                        <Marker
                            ...
                            icon={{
                                url: 'data:image/svg+xml;charset=UTF-8,' + encodeURIComponent(
                                    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32"><circle cx="16" cy="16" r="14" fill="%2322c55e" stroke="%23ffffff" stroke-width="2"/><text x="16" y="20" font-size="16" text-anchor="middle" fill="white" dominant-baseline="middle">ðŸ“</text></svg>'
                                ),
                                scaledSize: new window.google.maps.Size(40, 40),
                            }}
                        />
                        ...
                        >
                            <div className="bg-white p-4 rounded-lg shadow-lg max-w-xs">
                                ...
                                <p className="text-sm text-blue-600 font-semibold">
                                    Check route info in the sidebar â†’
                                </p>
                            </div>
                        </InfoWindow>
                    )}
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-700">
                                ...
                                <div className="max-h-56 overflow-y-auto space-y-2">
                                    {selectedHospital.pricing.map((item, idx) => (
                                        <div key={idx} className="bg-linear-to-r from-blue-900/40 to-sky-900/40 p-3 rounded-lg border border-blue-700/30 text-xs">
