                                        ...
                                        <div className="flex items-start justify-between mb-4">
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-2">
                                                ...
                                                <button 
                                                    ...
                                                    className="flex items-center gap-2 px-3 py-1.5 bg-linear-to-r from-teal-500 to-sky-600 text-white rounded-lg text-xs font-bold hover:shadow-lg hover:scale-105 transition transform"
                                                >
            ...
            {showSummaryModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[85vh]">
                        {/* Modal Header */}
                        <div className="bg-linear-to-r from-teal-600 to-sky-600 p-6 flex justify-between items-center text-white shrink-0">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-teal-100 text-xs">Powered by HealthPath AI</p>
                                </div>
                            </div>
                        ...
                        <div className="p-6 overflow-y-auto bg-gray-50 flex-grow">
                            {summaryLoading ? (
                                ...
                                <div className="prose prose-teal max-w-none text-sm text-gray-700">
                                    <div className="bg-white p-5 rounded-xl border border-teal-100 shadow-sm whitespace-pre-wrap leading-relaxed">
                                        {summaryData}
                                    </div>
