// HealthPath/frontend/src/pages/DoctorLogin.jsx
...
const DoctorLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-sky-50 via-blue-50 to-teal-50 flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-sky-200 rounded-full mix-blend-multiply filter blur-xl opacity-60 animate-pulse"></div>
      ...
      <div className="bg-white/80 backdrop-blur-sm p-10 rounded-3xl shadow-2xl w-full max-w-md border border-sky-100 relative z-10 animate-fadeInUp">
        {/* Header */}
        <div className="flex flex-col items-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-sky-100 rounded-2xl mb-4 animate-bounce">
            <UserCheck className="h-8 w-8 text-sky-600"/>
          </div>
          <h2 className="text-4xl font-extrabold text-gray-800 mb-2 gradient-text">Doctor Login</h2>
          <p className="text-gray-500 text-center">Access your professional dashboard and manage patient consultations</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            ...
            <Link to="/doctor/register" className="text-sky-600 hover:text-sky-800 font-semibold ml-1 transition-colors duration-200 hover:underline">
              Register here
            </Link>
          </p>
        </div>
