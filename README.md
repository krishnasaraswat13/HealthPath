# HealthPath: Smart AI-Powered Diagnosis & Healthcare Platform  

##  Overview  
HealthPath is a one-stop AI-powered healthcare platform that bridges the gap between patients, doctors, and pharmacies. It uses machine learning models to predict diseases from symptoms, enables real-time doctor consultations, supports pharmacy integration, and provides navigation to nearby hospitals and medical stores.  
...
HealthPath addresses this by offering:  
